...
<div>
    <form class="needs-validation" action="index.php?menuop=atualizar-evento" method="post" novalidate>
        <div class="mb-3 col-1">
            ...
            <input class="form-control" type="text" name="idEvento" id="idEvento" value="<?= $dados["idEvento"] ?>"
                   readonly>
        </div>
        <div class="mb-3">
            <label for="tituloEvento" class="form-label">Título</label>
            <input class="form-control" type="text" name="tituloEvento" id="tituloEvento"
                   value="<?= $dados["tituloEvento"] ?>" required>
        </div>
        <div class="mb-3">
            ...
            <textarea name="descricaoEvento" id="descricaoEvento" cols="30" rows="5" class="form-control"
                      required><?= $dados["descricaoEvento"] ?></textarea>
        </div>
        <div class="row">
            <div class="mb-3 col-6">
                ...
                <input class="form-control" type="date" name="dataInicioEvento" id="dataInicioEvento"
                       value="<?= $dados["dataInicioEvento"] ?>" required>
            </div>
            <div class="mb-3 col-6">
                ...
                <input class="form-control" type="time" name="horaInicioEvento" id="horaInicioEvento"
                       value="<?= $dados["horaInicioEvento"] ?>" required>
            </div>
        </div>
        <div class="row">
            <div class="mb-3 col-6">
