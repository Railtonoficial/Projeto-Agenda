...
<div class="d-flex align-items-center mb-2">
    <form action="index.php?menuop=eventos" method="post" class="d-flex">
    ...
    <a class="btn btn-outline-secondary ms-2" href="index.php?menuop=cad-evento">
            ...
            <tr>
                <td class="text-center">
                    <a class="btn btn-secondary btn-sm"
                       href="index.php?menuop=eventos&pagina=<?= $pagina ?>&idEvento=<?= $dados['idEvento'] ?>&statusEvento=<?= $dados['statusEvento'] ?>">
                        <?php
                ...
                <td class="text-center">
                    <a class="btn btn-outline-warning btn-sm"
                       href="index.php?menuop=editar-evento&idEvento=<?= $dados['idEvento'] ?>"><i
                                class="bi bi-pencil-square"></i></a>

                </td>
                <td class="text-center">
                    <a class="btn btn-outline-danger btn-sm"
                       href="index.php?menuop=excluir-evento&idEvento=<?= $dados['idEvento'] ?>"><i
