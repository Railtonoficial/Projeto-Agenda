...
<div class="d-flex align-items-center mb-2">
    ...
    <a class="btn btn-outline-secondary ms-2" href="index.php?menuop=cad-tarefa">
...
<div class="tabela">
    <table class="table table-dark table-striped table-bordered">
        ...
        $sql = "SELECT
            ...
            FROM tbtarefas
            WHERE tituloTarefa LIKE '%{$txt_pesquisa}%' OR
        ...
        while ($dados = mysqli_fetch_assoc($rs)) {
            ...
            <tr>
                ...
                <td class="text-center"><a class="btn btn-outline-warning btn-sm"
                                           href="index.php?menuop=editar-tarefa&idTarefa=<?= $dados["idTarefa"] ?>"><i
                                class="bi bi-pencil-square"></i></a></td>
                <td class="text-center"><a class="btn btn-outline-danger btn-sm"
                                           href="index.php?menuop=excluir-tarefa&idTarefa=<?= $dados["idTarefa"] ?>"><i
...
<ul class="pagination justify-content-center">
    ...
    if ($pagina > 6) {
        ?>
        <li class="page-item"><a class="page-link" href="?menuop=tarefas&pagina=<?php echo $pagina - 1 ?>"> << </a>
        </li>
        <?php
    }
