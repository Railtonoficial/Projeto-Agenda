...
<div class="d-flex align-items-center mb-2">
    <form action="index.php?menuop=contatos" method="post" class="d-flex">
        <div class="input-group">
            <input class="form-control" type="text" name="txt_pesquisa" style="width: 450px;"
                   value="<?= $txt_pesquisa ?>">
    ...
    <a class="btn btn-outline-secondary ms-2" href="index.php?menuop=cad-contato">
        <i class="bi bi-person-add"></i> Novo Contato
    </a>
</div>
    ...
    <table class="table table-dark table-striped table-bordered">
        ...
        $sql = "SELECT
            ...
            ELSE
                'NÃO ESPECIFICADO'
            END AS sexoContato,
            DATE_FORMAT(dataNascContato, '%d/%m/%Y') AS dataNascContato, flagFavoritoContato
            FROM tbcontatos WHERE idContato = '{$txt_pesquisa}'
        ...
        while ($dados = mysqli_fetch_assoc($rs)) {
            ...
            <tr>
                ...
                <td class="text-center"><a class="btn btn-outline-warning btn-sm"
                                           href="index.php?menuop=editar-contato&idContato=<?= $dados["idContato"] ?>"><i
                                class="bi bi-pencil-square"></i></a></td>
                <td class="text-center"><a class="btn btn-outline-danger btn-sm"
                                           href="index.php?menuop=excluir-contato&idContato=<?= $dados["idContato"] ?>"><i
